...
مرحباً بكم في [اسم المتجر]. نحن نلتزم بحماية خصوصيتك وبياناتك الشخصية وفقاً لأعلى المعايير الدولية وقوانين المملكة العربية السعودية. تشرح هذه السياسة كيفية جمع واستخدام وحماية معلوماتك الشخصية.

1. مقدمة
   نحن [اسم المتجر]، شركة مسجلة في المملكة العربية السعودية برقم السجل التجاري [رقم السجل التجاري]، ومقرها الرئيسي في [العنوان]. نحن مسؤولون عن معالجة بياناتك الشخصية وفقاً لنظام حماية البيانات الشخصية الصادر بالمرسوم الملكي رقم (م/19) وتاريخ 9/2/1443هـ.
                ...
                <Card>
                    <CardContent className="pt-6">
                        ...
                        <div className="mt-2 text-xs text-muted-foreground space-y-1">
                            ...
                            <div>• تأكد من تحديث معلومات التواصل والمتجر</div>
                        </div>
                    </CardContent>
                </Card>
