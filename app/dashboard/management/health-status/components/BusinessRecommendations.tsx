      ...
      <CardContent className="space-y-4">
        {criticalMissing.length > 0 && (
          <div className="p-4 bg-red-100 dark:bg-red-800 border border-red-600 dark:border-red-600 rounded-lg">
            ...
            <p className="text-sm text-red-900 dark:text-red-100 mb-2">هذه البيانات مطلوبة لبدء العمليات التجارية بشكل قانوني وفعال:</p>
        ...
        {importantMissing.length > 0 && (
          <div className="p-4 bg-orange-100 dark:bg-orange-800 border border-orange-600 dark:border-orange-600 rounded-lg">
            ...
            <p className="text-sm text-orange-900 dark:text-orange-100 mb-2">هذه البيانات ستحسن من تجربة العملاء وكفاءة العمليات:</p>
        ...
        {isComplete && (
          <div className="p-4 bg-green-100 dark:bg-green-800 border border-green-600 dark:border-green-600 rounded-lg">
            ...
            <p className="text-sm text-green-900 dark:text-green-100">متجرك جاهز للعمل بكفاءة عالية! جميع البيانات الأساسية والمهمة مكتملة.</p>
          </div>
        )}
      </CardContent>
    </Card>
